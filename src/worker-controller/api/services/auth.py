...
Provides session-based and JWT Bearer token authentication for the Worker Controller service.
"""
...
class AuthSettings:
    ...
    redis_key_prefix: str = "wc_session:"  # Unique prefix for worker-controller
