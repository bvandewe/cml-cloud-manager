...
This controller serves the Worker Controller admin interface.
The UI is a simple Bootstrap 5 dashboard showing CMLWorker statuses,
AWS EC2 management, and infrastructure monitoring.
"""
...
<head>
    ...
    <style>
        body {{ background: linear-gradient(135deg, #f39c12 0%, #e74c3c 100%); min-height: 100vh; }}
            ...
            <div class="col-md-8 col-lg-6">
                <div class="card">
                    <div class="card-body text-center p-5">
                        <h1 class="mb-3">🖥️ {self._settings.app_name}</h1>
                        <p class="text-muted mb-4">Version {self._settings.app_version} <span class="badge bg-secondary">{self._settings.image_tag}</span></p>
                        <p class="lead">Worker Controller manages CMLWorker lifecycle and AWS EC2 infrastructure.</p>
                        <hr class="my-4">
                        <div class="d-grid gap-2">
                            <a href="/api/docs" class="btn btn-warning btn-lg">
                                📚 API Documentation
                            </a>
