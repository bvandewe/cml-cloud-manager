...
This controller serves the Lablet Controller admin interface.
The UI is a simple Bootstrap 5 dashboard showing lablet statuses,
lab management, and integration with CML workers.
"""
...
<head>
    ...
    <style>
        body {{ background: linear-gradient(135deg, #2ecc71 0%, #27ae60 100%); min-height: 100vh; }}
            ...
            <div class="col-md-8 col-lg-6">
                <div class="card">
                    <div class="card-body text-center p-5">
                        ...
                        <p class="lead">Lablet Controller manages LabletSession lifecycle and CML lab integration.</p>
                        <hr class="my-4">
