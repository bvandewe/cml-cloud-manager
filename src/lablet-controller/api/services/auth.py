...
Provides session-based and JWT Bearer token authentication for the Lablet Controller service.
"""
...
class AuthSettings:
    ...
    redis_key_prefix: str = "lc_session:"  # Unique prefix for lablet-controller
